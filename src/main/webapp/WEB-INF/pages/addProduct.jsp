...
<t:pageTemplate pageTitle="Add Product">
  <h3 class="mt-5 mb-5 font-weight-normal text-center">Add Products</h3>

  <!-- Form pentru adaugarea unui produs -->
  <div class="container d-flex justify-content-center text-center">
    <form class="needs-validation w-50" novalidate="" method="POST" action="${pageContext.request.contextPath}/AddProduct" enctype="multipart/form-data">
